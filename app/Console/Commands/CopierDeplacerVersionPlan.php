...
class CopierDeplacerVersionPlan extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'nextcloud:plan';
     ...
     * @var string
     */
    protected $description = 'Copier/Déplacer les versions de plan';
    ...
    public function handle()
    {
        ...
        $this->info('Successfully : déplacement et copie plan chantier.');
    }
}
