...
@section('content')
    ...
    <div class="card card-custom">
        ...
        <div class="card-body">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-9 col-xl-8">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4 my-2 my-md-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <select class="form-control" id="kt_datatable_search_status">
                                        ...
                                        @foreach ($type_clients as $key => $value)
                            ...
                            <div class="col-md-4 my-2 my-md-0">
                                <div class="d-flex align-items-center">
                                    <label class="mr-3 mb-0 d-none d-md-block">Entreprise:</label>
            ...
            <!--end: Search Form-->
            <!--begin: Datatable-->
            <table class="datatable datatable-bordered datatable-head-custom js-exportable" id="kt_datatable">
                <thead>
                <tr>
                    <th title="Field #1">Nom</th>
                    <th title="Field #2">Nom Complet</th>
                    <th title="Field #3">Types</th>
                    <th title="Field #4">Entreprise</th>
                </tr>
                </thead>
                <tbody>
                    @foreach ($data as $key => $value)
                        ...
                        <tr class="gradeX">
                            ...
                            <td>{{$value['type_client']['nom_display']}}</td>
                            <td>{{$value['entreprise'][0]['nom']}}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
